...
<div class="max-w-6xl mx-auto">
    <div class="mb-6">
        ...
        <p class="text-gray-600 mt-2">Manage expense categories</p>
    </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                ...
                <form method="POST" class="space-y-4">
                    ...
                    <?php if ($editCategory): ?>
                        <a 
                            href="categories.php" 
                            class="block w-full text-center bg-gray-300 text-gray-700 py-3 rounded-lg font-semibold hover:bg-gray-400 transition"
                        >
                            Cancel
                        </a>
                    <?php endif; ?>
