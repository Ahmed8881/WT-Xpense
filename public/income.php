...
<div class="space-y-8">
    ...
    <div class="text-center lg:text-left">
        <h1 class="text-4xl font-bold text-gray-900">Income Management</h1>
        <p class="text-gray-600 mt-2 text-lg">Track and manage your income sources</p>
    </div>

    <!-- Success/Error Messages -->
    <?php if ($message): ?>
        <div class="p-4 rounded-2xl shadow-lg <?php echo $messageType === 'success' ? 'bg-green-50 border border-green-200 text-green-800' : 'bg-red-50 border border-red-200 text-red-800'; ?>">
        ...
        <div class="xl:col-span-1 space-y-8">
            ...
            <div class="bg-white rounded-3xl shadow-lg p-8">
                ...
                <div>
                    ...
                    <div class="card-analytic-bar">
                        <div class="card-analytic-bar-inner bg-gradient-to-r from-green-400 to-green-600" style="width: <?php echo $incomePercent; ?>%"></div>
                    </div>
            ...
            <div class="bg-white rounded-3xl shadow-lg p-8">
                ...
                <form method="POST" class="space-y-6">
                    ...
                    <button 
                        type="submit" 
                        class="w-full bg-gradient-to-r from-green-500 to-green-600 text-white py-3 px-6 rounded-xl font-semibold hover:from-green-600 hover:to-green-700 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                    >
            ...
            <div class="bg-white rounded-3xl shadow-lg p-8">
                <div class="flex items-center justify-between mb-8">
                    ...
                    <div class="bg-gray-100 px-4 py-2 rounded-xl">
                        <span class="text-sm font-semibold text-gray-600"><?php echo count($incomes); ?> Records</span>
                    </div>
                </div>
                ...
                <?php if (empty($incomes)): ?>
                    <div class="text-center py-16">
                        ...
                        <div class="bg-gradient-to-r from-green-100 to-blue-100 rounded-2xl p-4 inline-block">
                            <p class="text-sm text-gray-600">💡 Tip: Regular income tracking helps you understand your financial patterns</p>
                        </div>
                    </div>
                <?php else: ?>
                                ...
                                <?php foreach ($incomes as $index => $income): ?>
                                    <tr class="hover:bg-gray-50 transition-colors group">
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="text-xs text-gray-500">
                                                        <?php echo date('l', strtotime($income['date'])); ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4">
                                            ...
                                            <div class="text-xs text-gray-500">
                                                Income #<?php echo str_pad($income['id'], 4, '0', STR_PAD_LEFT); ?>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <form method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this income record?');">
                                                <input type="hidden" name="action" value="delete">
                                                <input type="hidden" name="id" value="<?php echo $income['id']; ?>">
                                                <button 
                                                    type="submit" 
                                                    class="text-red-500 hover:text-red-700 font-medium px-4 py-2 rounded-lg hover:bg-red-50 transition-all group-hover:bg-red-100"
                                                    title="Delete Income"
                                                >
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200">
                        <div class="flex justify-between items-center">
                            ...
                            <div class="text-right">
                                ...
                                <div class="text-2xl font-bold text-green-600">$<?php echo number_format($totalIncome, 2); ?></div>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
